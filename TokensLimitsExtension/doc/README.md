...
4. Единый `UsageRefreshCoordinator` асинхронно получает snapshot для включённых провайдеров.
5. Страница показывает основной/дополнительный window, тариф, дополнительные лимиты и метрики.
6. Смена языка обновляет UI без сетевого запроса; изменение конфигурации провайдера очищает его старый snapshot и запускает обновление.
...
- [Примечания к релизу v0.0.5.6](release-notes-v0.0.5.6.md)
- [Примечания к релизу v0.0.5.5](release-notes-v0.0.5.5.md)
- [Непубликованный кандидат v0.0.5.3](release-notes-v0.0.5.3.md)
- [Непубликованный кандидат v0.0.5.2](release-notes-v0.0.5.2.md)
- [Неопубликованный кандидат v0.0.5.1](release-notes-v0.0.5.1.md)
