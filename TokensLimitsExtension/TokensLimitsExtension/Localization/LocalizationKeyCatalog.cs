...
public static class LocalizationKeyCatalog
{
    ...
    [
        ...
        "status.nextStep.rateLimited",
        "status.nextStep.network",
        "status.nextStep.unsupported",
        "status.nextStep.retry",
        "status.dock.configure",
        "status.dock.authentication",
        "status.dock.rateLimited",
        "status.dock.network",
        "status.dock.unsupported",
