...
Pre-release builds are not shown by the `latest` link. For the v0.0.5.5 field-test candidate, use its [tag-specific release page](https://github.com/NFoxNet/tokens_bar_pt_palette/releases/tag/v0.0.5.5); see the [acceptance notes](TokensLimitsExtension/doc/release-notes-v0.0.5.5.md).
